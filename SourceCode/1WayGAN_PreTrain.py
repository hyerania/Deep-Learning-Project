...
for epoch in range(NUM_EPOCHS_PRETRAIN):
    for i,  (target, input) in enumerate(trainLoader1, 0):
        ...
        if i % 200 == 200:    # print every 200 mini-batches
            ...
            running_loss = 0.0
            save_image(generated_enhanced_image.data[:25], "./model/pretrain_images/gan1_pretrain_%d_%d.png" % (epoch,i), nrow=5, normalize=True)
            torch.save(generator1.state_dict(), './model/pretrain_checkpoint/gan1_pretrain_'+ str(epoch) + '_' + str(i) + '.pth')
